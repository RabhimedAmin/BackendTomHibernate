...
/**
 * DemPropSuiviId generated by hbm2java
 */
@Embeddable
public class DemPropSuiviId implements java.io.Serializable {
	...
	public DemPropSuiviId() {
	}

	public DemPropSuiviId(BigDecimal idDem, String CProp, String groupe, Date DSuivi) {
		this.idDem = idDem;
		this.CProp = CProp;
		this.groupe = groupe;
		this.DSuivi = DSuivi;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DemPropSuiviId))
			return false;
		DemPropSuiviId castOther = (DemPropSuiviId) other;
